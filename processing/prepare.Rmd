...
# Participación cívica en la escuela
data2009_col$IS2G15B <-sjmisc::rec(data2009_col$IS2G15B,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_col$IS2G15C <-sjmisc::rec(data2009_col$IS2G15C,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_col$IS2G15D <-sjmisc::rec(data2009_col$IS2G15D,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_col$IS2G15E <-sjmisc::rec(data2009_col$IS2G15E,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_col <- data2009_col %>%
  rowwise() %>%
  mutate(PARTSCHL_rec =
           mean(c(IS2G15B, IS2G15C, IS2G15D, IS2G15E), na.rm = T))
...
# Participación cívica en la escuela
data2009_dom$IS2G15B <-sjmisc::rec(data2009_dom$IS2G15B,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_dom$IS2G15C <-sjmisc::rec(data2009_dom$IS2G15C,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_dom$IS2G15D <-sjmisc::rec(data2009_dom$IS2G15D,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_dom$IS2G15E <-sjmisc::rec(data2009_dom$IS2G15E,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_dom <- data2009_dom %>%
  rowwise() %>%
  mutate(PARTSCHL_rec =
           mean(c(IS2G15B, IS2G15C, IS2G15D, IS2G15E), na.rm = T))
...
# Participación cívica en la escuela
data2009_mex$IS2G15B <-sjmisc::rec(data2009_mex$IS2G15B,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_mex$IS2G15C <-sjmisc::rec(data2009_mex$IS2G15C,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_mex$IS2G15D <-sjmisc::rec(data2009_mex$IS2G15D,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_mex$IS2G15E <-sjmisc::rec(data2009_mex$IS2G15E,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_mex <- data2009_mex %>%
  rowwise() %>%
  mutate(PARTSCHL_rec =
           mean(c(IS2G15B, IS2G15C, IS2G15D, IS2G15E), na.rm = T))
...
# Participación cívica en la escuela
data2016_col$IS3G16A <-sjmisc::rec(data2016_col$IS3G16A,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_col$IS3G16B <-sjmisc::rec(data2016_col$IS3G16B,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_col$IS3G16C <-sjmisc::rec(data2016_col$IS3G16C,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_col$IS3G16D <-sjmisc::rec(data2016_col$IS3G16D,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_col <- data2016_col %>%
  rowwise() %>%
  mutate(S_SCHPART_rec =
           mean(c(IS3G16A, IS3G16B, IS3G16C, IS3G16D), na.rm = T))
...
# Participación cívica en la escuela
data2016_dom$IS3G16A <-sjmisc::rec(data2016_dom$IS3G16A,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_dom$IS3G16B <-sjmisc::rec(data2016_dom$IS3G16B,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_dom$IS3G16C <-sjmisc::rec(data2016_dom$IS3G16C,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_dom$IS3G16D <-sjmisc::rec(data2016_dom$IS3G16D,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_dom <- data2016_dom %>%
  rowwise() %>%
  mutate(S_SCHPART_rec =
           mean(c(IS3G16A, IS3G16B, IS3G16C, IS3G16D), na.rm = T))
...
# Participación cívica en la escuela
data2016_mex$IS3G16A <-sjmisc::rec(data2016_mex$IS3G16A,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_mex$IS3G16B <-sjmisc::rec(data2016_mex$IS3G16B,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_mex$IS3G16C <-sjmisc::rec(data2016_mex$IS3G16C,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_mex$IS3G16D <-sjmisc::rec(data2016_mex$IS3G16D,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_mex <- data2016_mex %>%
  rowwise() %>%
  mutate(S_SCHPART_rec =
           mean(c(IS3G16A, IS3G16B, IS3G16C, IS3G16D), na.rm = T))
