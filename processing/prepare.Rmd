...
# Centrado
data2009_chl0 = data2009_chl0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(SCSTUDOP, na.rm = T))

## Nivel 1: al promedio del grupo
#data2009_chl0$SCSTUDOP = misty::center(data2009_chl0$SCSTUDOP, type = "CWC", group = data2009_chl0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2009_chl0$mean_op_esc = center(data2009_chl0$mean_op_esc, type = c("CGM"))
```
...
# Centrado
data2009_col0 = data2009_col0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(SCSTUDOP, na.rm = T))
## Nivel 1: al promedio del grupo
#data2009_col0$SCSTUDOP = misty::center(data2009_col0$SCSTUDOP, type = "CWC", group = data2009_col0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2009_col0$mean_op_esc = center(data2009_col0$mean_op_esc, type = c("CGM"))
```
...
# Centrado
data2009_dom0 = data2009_dom0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(SCSTUDOP, na.rm = T))
## Nivel 1: al promedio del grupo
#data2009_dom0$SCSTUDOP = misty::center(data2009_dom0$SCSTUDOP, type = "CWC", group = data2009_dom0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2009_dom0$mean_op_esc = center(data2009_dom0$mean_op_esc, type = c("CGM"))
```
...
# Centrado
data2009_mex0 = data2009_mex0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(SCSTUDOP, na.rm = T))
## Nivel 1: al promedio del grupo
#data2009_mex0$SCSTUDOP = misty::center(data2009_mex0$SCSTUDOP, type = "CWC", group = data2009_mex0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2009_mex0$mean_op_esc = center(data2009_mex0$mean_op_esc, type = c("CGM"))
```
...
# Centrado
data2016_chl0 = data2016_chl0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(C_STDCOM, na.rm = T))

## Nivel 1: al promedio del grupo
#data2016_chl0$C_STDCOM = misty::center(data2016_chl0$C_STDCOM, type = "CWC", group = data2016_chl0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2016_chl0$mean_op_esc = center(data2016_chl0$mean_op_esc, type = c("CGM"))
...
# Centrado
data2016_col0 = data2016_col0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(C_STDCOM, na.rm = T))

## Nivel 1: al promedio del grupo
#data2016_col0$C_STDCOM = misty::center(data2016_col0$C_STDCOM, type = "CWC", group = data2016_col0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2016_col0$mean_op_esc = center(data2016_col0$mean_op_esc, type = c("CGM"))
```
...
# Centrado
data2016_dom0 = data2016_dom0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(C_STDCOM, na.rm = T))

## Nivel 1: al promedio del grupo
#data2016_dom0$C_STDCOM = misty::center(data2016_dom0$C_STDCOM, type = "CWC", group = data2016_dom0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2016_dom0$mean_op_esc = center(data2016_dom0$mean_op_esc, type = c("CGM"))
```
...
# Centrado
data2016_mex0 = data2016_mex0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(C_STDCOM, na.rm = T))
## Nivel 1: al promedio del grupo
#data2016_mex0$C_STDCOM = misty::center(data2016_mex0$C_STDCOM, type = "CWC", group = data2016_mex0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2016_mex0$mean_op_esc = center(data2016_mex0$mean_op_esc, type = c("CGM"))
```
