...
data2009_chl$HOMELIT_idem <- ifelse((data2009_chl$HOMELIT==0), 0,
...
data2009_chl$HOMELIT2 <- ifelse((data2009_chl$HOMELIT==0), 0,
                   ifelse((data2009_chl$HOMELIT==1), 0,                                 
                          ifelse((data2009_chl$HOMELIT==2), 0,                           
                                 ifelse((data2009_chl$HOMELIT==3), 1,
                                        ifelse((data2009_chl$HOMELIT==4), 1,
                                               ifelse((data2009_chl$HOMELIT==5), 1, NA)))))) #más de 100 libros
...
data2009_chl$IS2G15B <-sjmisc::rec(data2009_chl$IS2G15B,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_chl$IS2G15C <-sjmisc::rec(data2009_chl$IS2G15C,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_chl$IS2G15D <-sjmisc::rec(data2009_chl$IS2G15D,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_chl$IS2G15E <-sjmisc::rec(data2009_chl$IS2G15E,rec="1=4;2=3;3=2;4=1;else=copy")
data2009_chl <- data2009_chl %>%
  rowwise() %>%
  mutate(PARTSCHL_rec =
...
# Centrado
data2009_chl0 = data2009_chl0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(PARTSCHL, na.rm = T))

## Nivel 1: al promedio del grupo
data2009_chl0$PARTSCHL = misty::center(data2009_chl0$PARTSCHL, type = "CWC", group = data2009_chl0$IDSCHOOL.x)
...
# Cantidad de libros en el hogar
data2009_col$HOMELIT_idem <- ifelse((data2009_col$HOMELIT==0), 0,
...
data2009_col$HOMELIT2 <- ifelse((data2009_col$HOMELIT==0), 0,
                   ifelse((data2009_col$HOMELIT==1), 0,                                 
                          ifelse((data2009_col$HOMELIT==2), 0,                           
                                 ifelse((data2009_col$HOMELIT==3), 1,
                                        ifelse((data2009_col$HOMELIT==4), 1,
                                               ifelse((data2009_col$HOMELIT==5), 1, NA)))))) #más de 100 libros
...
# Centrado
data2009_col0 = data2009_col0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(PARTSCHL, na.rm = T))
## Nivel 1: al promedio del grupo
data2009_col0$PARTSCHL = misty::center(data2009_col0$PARTSCHL, type = "CWC", group = data2009_col0$IDSCHOOL.x)
## Nivel 2: al gran promedio
...
# Cantidad de libros en el hogar
data2009_dom$HOMELIT_idem <- ifelse((data2009_dom$HOMELIT==0), 0,
...
data2009_dom$HOMELIT2 <- ifelse((data2009_dom$HOMELIT==0), 0,
                   ifelse((data2009_dom$HOMELIT==1), 0,                                 
                          ifelse((data2009_dom$HOMELIT==2), 0,                           
                                 ifelse((data2009_dom$HOMELIT==3), 1,
                                        ifelse((data2009_dom$HOMELIT==4), 1,
                                               ifelse((data2009_dom$HOMELIT==5), 1, NA)))))) #más de 100 libros
...
# Centrado
data2009_dom0 = data2009_dom0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(PARTSCHL, na.rm = T))
## Nivel 1: al promedio del grupo
data2009_dom0$PARTSCHL = misty::center(data2009_dom0$PARTSCHL, type = "CWC", group = data2009_dom0$IDSCHOOL.x)
## Nivel 2: al gran promedio
...
# Cantidad de libros en el hogar
data2009_mex$HOMELIT_idem <- ifelse((data2009_mex$HOMELIT==0), 0,
...
data2009_mex$HOMELIT2 <- ifelse((data2009_mex$HOMELIT==0), 0,
                   ifelse((data2009_mex$HOMELIT==1), 0,                                 
                          ifelse((data2009_mex$HOMELIT==2), 0,                           
                                 ifelse((data2009_mex$HOMELIT==3), 1,
                                        ifelse((data2009_mex$HOMELIT==4), 1,
                                               ifelse((data2009_mex$HOMELIT==5), 1, NA)))))) #más de 100 libros
...
# Centrado
data2009_mex0 = data2009_mex0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(PARTSCHL, na.rm = T))
## Nivel 1: al promedio del grupo
data2009_mex0$PARTSCHL = misty::center(data2009_mex0$PARTSCHL, type = "CWC", group = data2009_mex0$IDSCHOOL.x)
## Nivel 2: al gran promedio
...
data2016_chl$S_HISCED2 <- ifelse((data2016_chl$S_HISCED==0), 0, # did not complete <ISCED level 2>
                   ifelse((data2016_chl$S_HISCED==1), 1, # <ISCED level 2>                               
                          ifelse((data2016_chl$S_HISCED==2), 2, # <ISCED level 3> 
                                 ifelse((data2016_chl$S_HISCED==3), 3, # <ISCED level 4 or 5> o <ISCED level 4 or 5>
                                        ifelse((data2016_chl$S_HISCED==4), 3, NA))))) # <ISCED level 4 or 5> o <ISCED level 4 or 5>

# Libros
data2016_chl$S_HOMLIT2 <- ifelse((data2016_chl$S_HOMLIT==0), 0,
                   ifelse((data2016_chl$S_HOMLIT==1), 0, 
                          ifelse((data2016_chl$S_HOMLIT==2), 0,
                                 ifelse((data2016_chl$S_HOMLIT==3), 1, 
                                        ifelse((data2016_chl$S_HOMLIT==4), 1, NA))))) 
...
# Participación cívica en la escuela
data2016_chl$IS3G16A <-sjmisc::rec(data2016_chl$IS3G16A,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_chl$IS3G16B <-sjmisc::rec(data2016_chl$IS3G16B,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_chl$IS3G16C <-sjmisc::rec(data2016_chl$IS3G16C,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_chl$IS3G16D <-sjmisc::rec(data2016_chl$IS3G16D,rec="1=4;2=3;3=2;4=1;else=copy")
data2016_chl <- data2016_chl %>%
  rowwise() %>%
...
# Centrado
data2016_chl0 = data2016_chl0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(S_SCHPART, na.rm = T))

## Nivel 1: al promedio del grupo
data2016_chl0$S_SCHPART = misty::center(data2016_chl0$S_SCHPART, type = "CWC", group = data2016_chl0$IDSCHOOL.x)
## Nivel 2: al gran promedio
data2016_chl0$mean_op_esc = misty::center(data2016_chl0$mean_op_esc, type = c("CGM"))
data2016_chl0$S_SCHPART
data2016_chl0$mean_op_esc
```
...
data2016_col$S_HISCED2 <- ifelse((data2016_col$S_HISCED==0), 0, # did not complete <ISCED level 2>
                   ifelse((data2016_col$S_HISCED==1), 1, # <ISCED level 2>                               
                          ifelse((data2016_col$S_HISCED==2), 2, # <ISCED level 3> 
                                 ifelse((data2016_col$S_HISCED==3), 3, # <ISCED level 4 or 5> o <ISCED level 4 or 5>
                                        ifelse((data2016_col$S_HISCED==4), 3, NA))))) # <ISCED level 4 or 5> o <ISCED level 4 or 5>

# Libros
data2016_col$S_HOMLIT2 <- ifelse((data2016_col$S_HOMLIT==0), 0,
                   ifelse((data2016_col$S_HOMLIT==1), 0, 
                          ifelse((data2016_col$S_HOMLIT==2), 0,
                                 ifelse((data2016_col$S_HOMLIT==3), 1, 
                                        ifelse((data2016_col$S_HOMLIT==4), 1, NA))))) 

data2016_col_lat <- read_sav("../input/data/original/2016/ISLCOLC3.sav")
...
# Centrado
data2016_col0 = data2016_col0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(S_SCHPART, na.rm = T))

## Nivel 1: al promedio del grupo
data2016_col0$S_SCHPART = misty::center(data2016_col0$S_SCHPART, type = "CWC", group = data2016_col0$IDSCHOOL.x)
## Nivel 2: al gran promedio
...
data2016_dom$S_HISCED2 <- ifelse((data2016_dom$S_HISCED==0), 0, # did not complete <ISCED level 2>
                   ifelse((data2016_dom$S_HISCED==1), 1, # <ISCED level 2>                               
                          ifelse((data2016_dom$S_HISCED==2), 2, # <ISCED level 3> 
                                 ifelse((data2016_dom$S_HISCED==3), 3, # <ISCED level 4 or 5> o <ISCED level 4 or 5>
                                        ifelse((data2016_dom$S_HISCED==4), 3, NA))))) # <ISCED level 4 or 5> o <ISCED level 4 or 5>

# Libros
data2016_dom$S_HOMLIT2 <- ifelse((data2016_dom$S_HOMLIT==0), 0,
                   ifelse((data2016_dom$S_HOMLIT==1), 0, 
                          ifelse((data2016_dom$S_HOMLIT==2), 0,
                                 ifelse((data2016_dom$S_HOMLIT==3), 1, 
                                        ifelse((data2016_dom$S_HOMLIT==4), 1, NA))))) 


data2016_dom_lat <- read_sav("../input/data/original/2016/ISLDOMC3.sav")
...
# Centrado
data2016_dom0 = data2016_dom0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(S_SCHPART, na.rm = T))

## Nivel 1: al promedio del grupo
data2016_dom0$S_SCHPART = misty::center(data2016_dom0$S_SCHPART, type = "CWC", group = data2016_dom0$IDSCHOOL.x)
## Nivel 2: al gran promedio
...
data2016_mex$S_HISCED2 <- ifelse((data2016_mex$S_HISCED==0), 0, # did not complete <ISCED level 2>
                   ifelse((data2016_mex$S_HISCED==1), 1, # <ISCED level 2>                               
                          ifelse((data2016_mex$S_HISCED==2), 2, # <ISCED level 3> 
                                 ifelse((data2016_mex$S_HISCED==3), 3, # <ISCED level 4 or 5> o <ISCED level 4 or 5>
                                        ifelse((data2016_mex$S_HISCED==4), 3, NA))))) # <ISCED level 4 or 5> o <ISCED level 4 or 5>

# Libros
data2016_mex$S_HOMLIT2 <- ifelse((data2016_mex$S_HOMLIT==0), 0,
                   ifelse((data2016_mex$S_HOMLIT==1), 0, 
                          ifelse((data2016_mex$S_HOMLIT==2), 0,
                                 ifelse((data2016_mex$S_HOMLIT==3), 1, 
                                        ifelse((data2016_mex$S_HOMLIT==4), 1, NA))))) 

# según lo que pude ver en https://centroestudios.mineduc.cl/wp-content/uploads/sites/100/2017/06/2013.pdf y en https://alianzapacifico.net/wp-content/uploads/GU%C3%8DA-SISTEMA-EDUCATIVO-DE-CHILE.pdf con la recodificación ahora el nivel 3 (que corresponde a isced 4 (o CINE)) corresponde a Educación Post-Secundaria no Terciaria, Educación terciaria, o postgrado

data2016_mex_lat <- read_sav("../input/data/original/2016/ISLMEXC3.sav")
data2016_mex0 <- full_join(data2016_mex, data2016_mex_lat, by="IDSTUD")
...
# Centrado
data2016_mex0 = data2016_mex0 %>% group_by(IDSCHOOL.x) %>% mutate(mean_op_esc=mean(S_SCHPART, na.rm = T))
## Nivel 1: al promedio del grupo
data2016_mex0$S_SCHPART = misty::center(data2016_mex0$S_SCHPART, type = "CWC", group = data2016_mex0$IDSCHOOL.x)
## Nivel 2: al gran promedio
