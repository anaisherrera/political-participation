...
data2009_chl=data2009_chl0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()
#data2009_chl=data2009_chl0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, mean_op_esc, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()

# data2009_chl2=data2009_chl0 %>% dplyr::select(HISCED2, HOMELIT2, HISEI, LEGPROT, ILLPROT, ELECPART, HISCED2, HOMELIT2, DISLAW, ATTVIOL, SCSTUDOP, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit() # bbdd con variable de estatus ocupacional,, disminuye el n y no se mide de la misma manera en las dos olas (en un caso solo se pregunta por la ocupación y en iccs 2016 se pregunta además por las actividades que hace). Esta es la variable: HISEI

load(file= "../input/data/proc/2009/data_col.Rdata")
data2009_col=data2009_col0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()
#data2009_col=data2009_col0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, mean_op_esc, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2009/data_dom.Rdata")
data2009_dom=data2009_dom0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()
#data2009_dom=data2009_dom0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, mean_op_esc, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2009/data_mex.Rdata")
data2009_mex=data2009_mex0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()
#data2009_mex=data2009_mex0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, CITEFF, SCSTUDOP, mean_op_esc, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()
```
...
# Variable Name: SCSTUDOP
# Description: Principals' perceptions of student opportunities to participate in community activities
# Procedure: IRT WLE scores with mean of 50 and standard deviation of 10 for equally weighted countries
# Source: 
...
#IC2G06F Campaigns to raise people’s awareness, such as <AIDS World Day, World No Tobacco Day>
#IC2G06G Activities related to improving facilities for the <local community> (for example, public gardens, libraries, health centres, recreation centres, community hall)
...
coef_names <- c(
          ...
          "Civic learning opportunities at school",
          "Civic knowledge"
          )
...
#          "Attitudes towards the use of violence",
#          "Citizenship self-efficacy",
#          "Civic learning opportunities at school (student)",
#          "Civic learning opportunities at school (school)",
#          "Civic knowledge"
#          )
...
reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_chl)
#reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_chl)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
#reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
...
reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_col)
#reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_col)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
#reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
...
reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_dom)
#reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_dom)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
#reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
...
reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_mex)
#reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_mex)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
#reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
...
reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL2), data=data2009)
#reg6 <- lmer(LEGPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL2), data=data2009)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL2), data=data2009)
reg8 <- lmer(LEGPROT ~ 1 + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2009)
reg9 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2009)
#reg9 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL2), data=data2009)
...
reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_chl)
#reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_chl)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
#reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
...
reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_col)
#reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_col)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
#reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
...
reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_dom)
#reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_dom)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
#reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
...
reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_mex)
#reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_mex)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
#reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
...
reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL2), data=data2009)
#reg6 <- lmer(ILLPROT ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL2), data=data2009)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL2), data=data2009)
reg8 <- lmer(ILLPROT ~ 1 + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2009)
reg9 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2009)
#reg9 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL2), data=data2009)
...
reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_chl)
#reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_chl)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
#reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
...
reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_col)
#reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_col)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
#reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
...
reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_dom)
#reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_dom)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
#reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
...
reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_mex)
#reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL), data=data2009_mex)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
#reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
...
reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL2), data=data2009)
#reg6 <- lmer(ELECPART ~ 1 + SCSTUDOP + mean_op_esc + (1 | IDSCHOOL2), data=data2009)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL2), data=data2009)
reg8 <- lmer(ELECPART ~ 1 + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2009)
reg9 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + PV1CIV + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2009)
#reg9 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + CITEFF + SCSTUDOP + mean_op_esc + PV1CIV + (1 | IDSCHOOL2), data=data2009)
...
data2016_chl=data2016_chl0 %>% dplyr::select(S_HISCED2, S_HOMLIT, S_LEGACT, S_ILLACT, S_ELECPART, L_DISLAW, L_ATTVIOL, C_STDCOM, S_CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2016/data_col.Rdata")
data2016_col=data2016_col0 %>% dplyr::select(S_HISCED2, S_HOMLIT, S_LEGACT, S_ILLACT, S_ELECPART, L_DISLAW, L_ATTVIOL, C_STDCOM, S_CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2016/data_dom.Rdata")
data2016_dom=data2016_dom0 %>% dplyr::select(S_HISCED2, S_HOMLIT, S_LEGACT, S_ILLACT, S_ELECPART, L_DISLAW, L_ATTVIOL, C_STDCOM, S_CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2016/data_mex.Rdata")
data2016_mex=data2016_mex0 %>% dplyr::select(S_HISCED2, S_HOMLIT, S_LEGACT, S_ILLACT, S_ELECPART, L_DISLAW, L_ATTVIOL, C_STDCOM, S_CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x, IDCNTRY=IDCNTRY.x) %>% as.data.frame() %>%  na.omit()
```
...
# Variable Name C_STDCOM 
# Description Principals' perceptions of student opportunities to participate in community activities
# Procedure IRT WLE scores with mean of 10 and standard deviation of 2 within each participating country
# Interpretation Higher values indicating higher levels of student opportunities
# Trend Status Not equated to ICCS 2009 given changes in stem: new scale with new name for ICCS 2016 (with similar content)
# Source 
#IC3G04A Activities related to environmental sustainability (e.g. <energy and water saving, recycling>)
#IC3G04B Human rights projects
#IC3G04C Activities for underprivileged people or groups
#IC3G04D Cultural activities (e.g. theatre, music)
#IC3G04E Multicultural and intercultural activities within the <local community> (e.g. <promotion and celebration of cultural diversity, food street market>)
#IC3G04F Campaigns to raise people’s awareness, such as <campaigns to raise people’s awareness about social issues, campaigns to raise people’s awareness of environmental issues>
#IC3G04G Activities aimed at protecting the cultural heritage within the <local community> 
#IC3G04H	Visits to political institutions (e.g. <Parliament house, Prime Minister’s/President’s official residence>)
#IC3G04I Sports events
...
reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_chl)
#reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_chl)
reg7 <- lmer(S_LEGACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
#reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
...
reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_col)
#reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_col)
reg7 <- lmer(S_LEGACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
#reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
...
reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_dom)
#reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_dom)
reg7 <- lmer(S_LEGACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
#reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
...
reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_mex)
#reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_mex)
reg7 <- lmer(S_LEGACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
#reg8 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
...
reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + (1 | IDSCHOOL2), data=data2016)
#reg6 <- lmer(S_LEGACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL2), data=data2016)
reg7 <- lmer(S_LEGACT ~ 1 + PV1CIV + (1 | IDSCHOOL2), data=data2016)
reg8 <- lmer(S_LEGACT ~ 1 + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2016)
reg9 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2016)
#reg9 <- lmer(S_LEGACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL2), data=data2016)
...
reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_chl)
#reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_chl)
reg7 <- lmer(S_ILLACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
#reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
...
reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_col)
#reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_col)
reg7 <- lmer(S_ILLACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
#reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
...
reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_dom)
#reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_dom)
reg7 <- lmer(S_ILLACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
#reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
...
reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_mex)
#reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_mex)
reg7 <- lmer(S_ILLACT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
#reg8 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
...
reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + (1 | IDSCHOOL2), data=data2016)
#reg6 <- lmer(S_ILLACT ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL2), data=data2016)
reg7 <- lmer(S_ILLACT ~ 1 + PV1CIV + (1 | IDSCHOOL2), data=data2016)
reg8 <- lmer(S_ILLACT ~ 1 + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2016)
reg9 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2016)
#reg9 <- lmer(S_ILLACT ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL2), data=data2016)
...
reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_chl)
#reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_chl)
reg7 <- lmer(S_ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
#reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_chl)
...
reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_col)
#reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_col)
reg7 <- lmer(S_ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
#reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_col)
...
reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_dom)
#reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_dom)
reg7 <- lmer(S_ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
#reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_dom)
...
reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + (1 | IDSCHOOL), data=data2016_mex)
#reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL), data=data2016_mex)
reg7 <- lmer(S_ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
#reg8 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL), data=data2016_mex)
...
reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + (1 | IDSCHOOL2), data=data2016)
#reg6 <- lmer(S_ELECPART ~ 1 + C_STDCOM + mean_op_esc + (1 | IDSCHOOL2), data=data2016)
reg7 <- lmer(S_ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL2), data=data2016)
reg8 <- lmer(S_ELECPART ~ 1 + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2016)
reg9 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + PV1CIV + factor(IDCNTRY2) + (1 | IDSCHOOL2), data=data2016)
#reg9 <- lmer(S_ELECPART ~ 1 + factor(S_HISCED2) + factor(S_HOMLIT) + L_DISLAW + L_ATTVIOL + S_CITEFF + C_STDCOM + mean_op_esc + PV1CIV + (1 | IDSCHOOL2), data=data2016)
