...
data2009_chl=data2009_chl0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, SCSTUDOP, CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()
...
data2009_col=data2009_col0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, SCSTUDOP, CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2009/data_dom.Rdata")
data2009_dom=data2009_dom0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, SCSTUDOP, CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()

load(file= "../input/data/proc/2009/data_mex.Rdata")
data2009_mex=data2009_mex0 %>% dplyr::select(HISCED2, HOMELIT2, LEGPROT, ILLPROT, ELECPART, DISLAW, ATTVIOL, SCSTUDOP, CITEFF, PV1CIV, IDSCHOOL=IDSCHOOL.x) %>% as.data.frame() %>%  na.omit()
```
...
reg5 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_chl)
reg6 <- lmer(LEGPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_chl)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
...
reg5 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_col)
reg6 <- lmer(LEGPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_col)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
...
reg5 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_dom)
reg6 <- lmer(LEGPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_dom)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
...
reg5 <- lmer(LEGPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_mex)
reg6 <- lmer(LEGPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_mex)
reg7 <- lmer(LEGPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
reg8 <- lmer(LEGPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
...
reg5 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_chl)
reg6 <- lmer(ILLPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_chl)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
...
reg5 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_col)
reg6 <- lmer(ILLPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_col)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
...
reg5 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_dom)
reg6 <- lmer(ILLPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_dom)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
...
reg5 <- lmer(ILLPROT ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_mex)
reg6 <- lmer(ILLPROT ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_mex)
reg7 <- lmer(ILLPROT ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
reg8 <- lmer(ILLPROT ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
...
reg5 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_chl)
reg6 <- lmer(ELECPART ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_chl)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_chl)
...
reg5 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_col)
reg6 <- lmer(ELECPART ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_col)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_col)
...
reg5 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_dom)
reg6 <- lmer(ELECPART ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_dom)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_dom)
...
reg5 <- lmer(ELECPART ~ 1 + SCSTUDOP + (1 | IDSCHOOL), data=data2009_mex)
reg6 <- lmer(ELECPART ~ 1 + CITEFF + (1 | IDSCHOOL), data=data2009_mex)
reg7 <- lmer(ELECPART ~ 1 + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
reg8 <- lmer(ELECPART ~ 1 + factor(HISCED2) + factor(HOMELIT2) + DISLAW + ATTVIOL + SCSTUDOP + CITEFF + PV1CIV + (1 | IDSCHOOL), data=data2009_mex)
...
# Datos 2016
```{r, include=FALSE}
#load(file= "../input/data/proc/2016/data2016.Rdata")
#data2016=data2016 %>% dplyr::select(S_HISCED2, S_HOMELIT, S_LEGACT, S_ILLACT, S_ELECPART, L_DISLAW, L_ATTVIOL, C_STDCOM, S_CITEFF, PV1CIV, idschool2) %>% as.data.frame() %>%  na.omit()

#load(file= "../input/data/proc/2016/datalat.Rdata")

#load(file= "../input/data/proc/2016/datachl.Rdata")
#datachl=datachl %>% dplyr::select(S_HISCED2, S_HOMELIT, S_LEGACT, S_ILLACT, S_ELECPART, L_DISLAW, L_ATTVIOL, C_STDCOM, S_CITEFF, PV1CIV, idschool2) %>% as.data.frame() %>%  na.omit()

#load(file= "../input/data/proc/2016/datacol.Rdata")
#load(file= "../input/data/proc/2016/datadom.Rdata")
#load(file= "../input/data/proc/2016/datamex.Rdata")
```
